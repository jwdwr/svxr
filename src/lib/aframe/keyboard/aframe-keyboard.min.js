!(function (e) {
		...
		AFRAME.registerComponent('a-keyboard', {
			...
			attachEventListeners: function () {
				window.addEventListener('keydown', this.handleKeyboardPress),
					this.el.addEventListener('mousedown', this.handleKeyboardVR);
			},
			removeEventListeners: function () {
				window.removeEventListener('keydown', this.handleKeyboardPress),
					this.el.removeEventListener('mousedown', this.handleKeyboardVR);
			},
	...
	function (e, t) {
		e.exports = function (e, t) {
			let a;
			const d = new Set([
					16, 17, 18, 20, 33, 34, 35, 36, 45, 46, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121,
					122, 123
				]),
			...
			switch (s) {
				...
				case 32:
					...
					break;
				default:
					(a = new CustomEvent('a-keyboard-update', { detail: { code: s, value: r } })),
						document.dispatchEvent(a);
			}
			if ('vr' !== t) {
				const t =
				...
				if (this.keyboardKeys) {
					...
					t.setAttribute('position', `${a / 2 - 0.02} ${-d / 2 + 0.02} -0.01`),
						...
						this.baseTexture && this.baseTexture.length > 0
							...
							: t.setAttribute('material', 'color: #4a4a4a; side: double; opacity: 0.7'),
					...
					for (let t = 0; t < e.length; t++) {
						...
						for (let e = 0; e < a.length; e++) {
							...
							const s = r.size.split(' ')[0],
								l = r.size.split(' ')[1];
							this.drawButton({ key: r, position: `${d + s / 2} ${n - l / 2} 0` }),
